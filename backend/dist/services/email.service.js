...
const sendInvoiceEmail = async (to, invoiceData, pdfBuffer, isReminder) => {
    ...
    return (0, exports.sendEmail)(to, subject, html, attachments);
};
exports.sendInvoiceEmail = sendInvoiceEmail;
// Send Quotation to Client with Public Link
const sendQuotationToClient = async (quotationData, publicUrl) => {
...
const sendContractNotification = async (contract, publicUrl) => {
...
const sendQuotationAcceptanceToClient = async (quotationData) => {
    ...
    `;
    return (0, exports.sendEmail)(quotationData.clientEmail, subject, html);
};
exports.sendQuotationAcceptanceToClient = sendQuotationAcceptanceToClient;
// Send Acceptance Notification to Company
const sendQuotationAcceptanceToCompany = async (quotationData) => {
...
exports.sendQuotationAcceptanceToCompany = sendQuotationAcceptanceToCompany;
// Send Rejection Notification to Company
const sendQuotationRejectionToCompany = async (quotationData) => {
...
exports.sendQuotationRejectionToCompany = sendQuotationRejectionToCompany;
// Send Quotation Reminder
const sendQuotationReminder = async (quotationData, publicUrl) => {
