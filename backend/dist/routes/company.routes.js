...
router.put('/logo', auth_1.authenticate, upload_1.uploadLogo.single('logo'), (req, res) => {
    Promise.resolve().then(() => __importStar(require('../controllers/company.controller'))).then(mod => mod.updateLogo(req, res));
});
