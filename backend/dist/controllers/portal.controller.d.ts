...
export declare const acceptQuotation: (req: ClientAuthRequest, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const rejectQuotation: (req: ClientAuthRequest, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
