  ...
  const plans = [
    {
      ...
      maxStorageGb: 1,
      maxCompanies: 1,
      enabledModules: { hrms: true, employees: true, attendance: true, leaves: true, payroll: true, clients: true, crm: true, invoices: true },
    ...
    },
    {
      ...
      maxStorageGb: 10,
      maxCompanies: 1,
      enabledModules: { hrms: true, employees: true, attendance: true, leaves: true, payroll: true, clients: true, crm: true, invoices: true, projects: true, accounting: true },
    ...
    },
    {
      ...
      maxStorageGb: 100,
      maxCompanies: 5,
      enabledModules: { hrms: true, employees: true, attendance: true, leaves: true, payroll: true, clients: true, crm: true, invoices: true, projects: true, accounting: true, recruitment: true, lms: true },
