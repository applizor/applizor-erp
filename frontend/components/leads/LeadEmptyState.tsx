...
export function LeadEmptyState() {
    return (
        <div className="ent-card p-12 flex flex-col items-center justify-center text-center border-2 border-dashed border-gray-200 bg-gray-50/50 animate-fade-in">
