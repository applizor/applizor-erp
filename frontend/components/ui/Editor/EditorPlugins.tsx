    ...
    useEffect(() => {
        return editor.registerCommand(
            ...
            (event: ClipboardEvent) => {
                ...
                // Handle image paste (upload & insert as ImageNode)
                ...
                // For text/HTML paste, let Lexical's default handler process it.
                // Lexical uses $generateNodesFromDOM which handles MS Word HTML,
                // inline styles, nested formatting etc. much better than the
                // custom importDOMNode that only handled 4 CSS properties.
                return false;
            },
