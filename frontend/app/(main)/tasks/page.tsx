...
import {
    ...
    Filter, LayoutGrid, Users, Calendar, Clock, Copy, Edit2, Trash2, Link as LinkIcon, ListTree, Briefcase
} from 'lucide-react';
...
export default function GlobalTasksPage() {
    ...
    // Fetch project members and sprints when selectedProjectId changes
    useEffect(() => {
    ...
    }, [selectedProjectId, selectedSprintId, toast]);
    ...
    const handleCopyLink = (taskId: string, targetProjectId: string) => {
    ...
    return (
        <div className="h-[calc(100vh-140px)] flex flex-col animate-fade-in space-y-6">
