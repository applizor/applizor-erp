...
import { ArrowLeft, Save, Plus, Trash2, Calculator, GripVertical, AlertCircle, CheckCircle2 } from 'lucide-react';
...
const evaluateFormula = (formula: string, context: Record<string, number>): number => {
    try {
        ...
        // Safety: Only allow digits, operators, dots, parens
...
export default function CreateSalaryTemplatePage() {
    ...
    // Preview Settings
    const [previewCtc, setPreviewCtc] = useState<number>(1200000); // Default 12L PA
    ...
    const calculatePreview = () => {
        ...
        templateComponents.forEach(tc => {
            ...
            else if (tc.calculationType === 'formula') val = 0; // Defer formula
        ...
        setPreviewGross(totalEarnings); // Assuming all non-deductions are earnings for simplicity in preview
        ...
        <div className="h-[calc(100vh-100px)] flex flex-col gap-4">
            ...
            <div className="flex justify-between items-center bg-white p-4 rounded-md border border-slate-200 shadow-sm shrink-0">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-lg font-black text-slate-900 uppercase tracking-tight leading-none">Template Builder</h2>
                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1">Advanced Remuneration Architect</p>
                    </div>
                </div>
