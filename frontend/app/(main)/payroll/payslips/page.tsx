        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center bg-slate-50/50 p-4 rounded-md border border-slate-100">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-sm font-black text-gray-900 uppercase tracking-tight">Remuneration Ledger</h2>
                        <p className="text-[9px] text-gray-400 font-bold uppercase tracking-widest leading-none">Historical Disbursement Registry</p>
                    </div>
                </div>
